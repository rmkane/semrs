...
--
-- Host: localhost
-- Generation Time: May 07, 2012 at 04:51 AM
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  PRIMARY KEY (`id`),
  KEY `message_ibfk_1` (`author`),
  KEY `message_ibfk_2` (`recipient`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `patient_data` (
  ...
  `drivers_license` blob NOT NULL,
  `national_id` blob NOT NULL,
  `occupation` longblob NOT NULL,
  `phone_home` blob NOT NULL,
  `phone_cell` blob NOT NULL,
  `pharmacy_id` bigint(20) NOT NULL DEFAULT '0',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `sex` blob NOT NULL,
  `ethnicity` blob NOT NULL,
  `race` blob NOT NULL,
  `homeless` blob NOT NULL,
  `mothers_name` blob NOT NULL,
  `guardians_name` blob NOT NULL,
  `deceased_date` blob,
  `deceased_reason` blob,
  `regdate` blob NOT NULL COMMENT 'Registration Date',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `visit` (
  ...
  `facility_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `visit_ibfk_1` (`patient_id`),
  KEY `visit_ibfk_2` (`physician_id`),
  KEY `visit_ibfk_3` (`facility_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`author`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `message_ibfk_2` FOREIGN KEY (`recipient`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `visit`
  ADD CONSTRAINT `visit_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient_data` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `visit_ibfk_2` FOREIGN KEY (`physician_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `visit_ibfk_3` FOREIGN KEY (`facility_id`) REFERENCES `facility` (`id`) ON DELETE CASCADE;
